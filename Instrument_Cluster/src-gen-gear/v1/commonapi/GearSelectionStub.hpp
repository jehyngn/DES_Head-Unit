...
class GearSelectionStubAdapter
 ...
 public:
    ...
    virtual void fireGearAttributeChanged(const int32_t &gear) = 0;
...
public:
    ...
    virtual bool onRemoteSetGearAttribute(const std::shared_ptr<CommonAPI::ClientId> _client, int32_t _value) = 0;
...
public:
    ...
    virtual const int32_t &getGearAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;
    /// sets attribute with the given value and propagates it to the adapter
    virtual void fireGearAttributeChanged(int32_t _value) {
